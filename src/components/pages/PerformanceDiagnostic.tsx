    ...
    return (
        <AppLayout>
            <div className="space-y-8 pb-20">
                <header className="flex flex-col md:flex-row justify-between items-start md:items-center bg-stellar/50 p-6 rounded-xl border border-argent/50 gap-4">
                    <div>
                        ...
                        {alerts.filter(a => a.severity !== "INFO").map(alert => (
                            <div key={alert.id} className={`p-5 rounded-xl border flex gap-4 transition-all hover:scale-[1.01] ${alert.severity === "CRITICAL" ? "bg-red-500/5 border-red-500/20 shadow-lg shadow-red-500/5" : "bg-stellar border-argent"}`}>
                                ...
                                <div>
                                    ...
                                    <p className="text-small text-text-secondary leading-relaxed">{alert.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
